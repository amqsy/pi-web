...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.auto": "跟隨系統（點選切換到 Macchiato）",
    "theme.macchiato": "Catppuccin Macchiato（點選切換到淺色）",
    "history.full": "完整紀錄",
    ...
    "i18n.openInExplorer": "在檔案總管中開啟",
    "i18n.openedInExplorer": "已在檔案總管中開啟",
    "i18n.openInExplorerFailed": "無法在檔案總管中開啟",
