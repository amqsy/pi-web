...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "theme.auto": "跟随系统（点击切换到 Macchiato）",
    "theme.macchiato": "Catppuccin Macchiato（点击切换到浅色）",
    "history.full": "完整历史",
    ...
    "i18n.openInExplorer": "在文件资源管理器中打开",
    "i18n.openedInExplorer": "已在文件资源管理器中打开",
    "i18n.openInExplorerFailed": "无法在文件资源管理器中打开",
