...
function ThemeIcon({ preference }: { preference: ThemePreference }) {
  ...
  if (preference === "macchiato") {
    return <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" /></svg>;
  }
...
function GeneralSettings({ sessionId, onSessionReloaded }: Pick<Props, "sessionId" | "onSessionReloaded">) {
  ...
  const themeOptions: { id: ThemePreference; label: string }[] = [
    ...
    { id: "macchiato", label: t("settings.themeMacchiato") },
  ];
